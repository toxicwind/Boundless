# AGENTS.md — Boundless (`/home/toxic/projects/boundless`)

**Role**: Accessibility-first EPUB, PDF, and DOCX document splitter designed for educational and high-volume reading (Bun-native, 50MB Natural Reader pipeline).
**Stack**: TypeScript, Bun runtime, PDF/EPUB parsing libraries.

---

## 🎯 Repository Specifics

- High-throughput document chunking and splitting for TTS / reading systems.
- Bun-first: Execute with `bun run`, test with `bun test`.
- Respect memory thresholds on large 50MB+ document splits.
